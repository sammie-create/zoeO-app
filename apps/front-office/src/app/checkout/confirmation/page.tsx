...
export default async function ConfirmationPage({
  ...
  return (
    <main className="mx-auto max-w-[720px] px-4 py-20 text-center sm:px-6 lg:px-8">
      <div className="mx-auto mb-6 grid size-16 place-items-center rounded-full bg-status-booked/15 text-status-booked">
        <Icon name="check" className="size-7" />
      </div>
      <span className="text-sm font-semibold tracking-[.18em] text-violet-400 uppercase">Order confirmed</span>
      <h1 className="font-display mt-3 mb-3 text-3xl font-bold sm:text-4xl">
      ...
      <p className="my-7 font-mono text-violet-300">#{ref}</p>
